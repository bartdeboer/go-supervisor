...
var (
	...
	ErrRecordTooLarge     = errors.New("initcfg: service record too large")
	ErrDuplicateField     = errors.New("initcfg: duplicate field")
	ErrMissingField       = errors.New("initcfg: missing required field")
